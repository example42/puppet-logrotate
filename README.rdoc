...
* You can create a single configuration snippet with these altenative defines:

  * logrotate::rule - Create snippets based of a lot parameters for each option

  * logrotate::conf - Create snippets based of a configrable template and the provided options
...
Travis {<img src="https://travis-ci.org/example42/puppet-logrotate.png?branch=master" alt="Build Status" />}[https://travis-ci.org/example42/puppet-logrotate]
